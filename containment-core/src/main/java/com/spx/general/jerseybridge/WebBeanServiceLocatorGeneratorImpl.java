...
public class WebBeanServiceLocatorGeneratorImpl extends org.jvnet.hk2.external.generator.ServiceLocatorGeneratorImpl {
  ...
  public ServiceLocator create(String name, ServiceLocator parent) {
    ...
    WebBeanServiceLocator sli =
        new WebBeanServiceLocator(name, super.create(name, parent), WebBeansContext.currentInstance());
    ...
    dci.bind(BuilderHelper.link(DynamicConfigurationServiceImpl.class, false).to(DynamicConfigurationService.class)
        .in(Singleton.class.getName()).localOnly().build());

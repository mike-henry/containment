...
public class EntityManagerBuilder {
  ...
  private Map<String, String> getDatabasConfiguration(DataSourceFactory database) {
    ...
    persistenceMap.put("hibernate.ejb.resource_scanner",
        com.spx.session.AuthorityEntityScanner.class.getName().toString());
  ...
  private EntityManager doCreatEntitityManagerFromPersitanceUnit(String persistanceUnitName,

...
@SuiteClasses(value = { 
        ...
        com.spx.containment.chain.InventoryRequestTest.class,
        com.spx.inventory.api.InventoryResourceTest.class,
        ...
        com.spx.inventory.services.InventoryLedgerTest.class,
